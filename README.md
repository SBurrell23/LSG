...
- **Key** and **Type** default to random. Key lists every major and minor key; Type lists the song feels grouped by time signature: 4/4 (Ballad, Medium, Rock Ballad, Blues, Boogie-Woogie, Gospel, Bossa Nova, Medium Swing, Medium-Up Swing, Latin, Funk, Reggae, Stride), 3/4 (Waltz, Slow Waltz, Jazz Waltz, Country Waltz), 2/4 (Samba, Ragtime, Polka, March, Tango, Habanera) and 6/8 (6/8 Ballad, Jig, Tarantella). Hover the dropdown to see what makes the selected type tick.
